...
assert any(message['Subject'] == 'New project inquiry' and
           any(recipient['Address'] == 'contact@example.invalid' for recipient in message['To'])
           for message in messages), 'Project inquiry mail not found in Mailpit'
print('Contact and project inquiry delivery passed in Mailpit.')
PY
        fi
    else
