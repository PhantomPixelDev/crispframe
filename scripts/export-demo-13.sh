...
vendor/bin/typo3 cache:flush
vendor/bin/typo3 impexp:export --type=xml --pid=1 --levels=999 --table=tt_content --include-related=_ALL --dependency=agency_theme --title='Crispframe 1.3 bilingual demo' crispframe-demo-v13
python3 - "$work/public/fileadmin/user_upload/_temp_/importexport/crispframe-demo-v13.xml" "$root/packages/agency_demo/Initialisation/data.xml" <<'PY'
import sys
from pathlib import Path
