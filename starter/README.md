...
2. On a fresh empty installation, optionally run `composer require crispframe/agency-demo:^1.3` followed by `vendor/bin/typo3 extension:setup --extension=agency_demo`. This imports editable sample pages and a bilingual site configuration.
