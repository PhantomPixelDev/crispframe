...
This is a clean TYPO3 13.4 Composer project. It requires the reusable theme without a local path repository. After the theme is published on Packagist, copy this directory to a new project and run `composer install`.
